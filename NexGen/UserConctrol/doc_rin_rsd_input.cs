...
{
    public partial class doc_rin_rsd_input : UserControl
    {
        ...
        public DataObject.Record_RIN_RSD GetRecord()
        {
            ...
            try
            {
                ...
                //}
                _sr_no++;
                var rs = new DataObject.Record_RIN_RSD
                {
                    Image_2 = null,
                    Price = price,
                    Qty = qty,
        ...
        public void Load_record_to_editting_form(DataObject.Record_RIN_RSD doc_rin_input)
        {
            txtItemNumber.Text = doc_rin_input.Item_number;
