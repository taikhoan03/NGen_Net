...
{
    public partial class doc_upc_input : UserControl
    {
        ...
        public DataObject.Record_UPC GetRecord()
        {
            ...
            try
            {
                ...
                //}
                _sr_no++;
                var rs = new DataObject.Record_UPC
                {
                    //Image_2 = null,
                    Price = price,
                    Qty = qty,
        ...
        public void Load_record_to_editting_form(DataObject.Record_UPC doc_rin_input)
        {
