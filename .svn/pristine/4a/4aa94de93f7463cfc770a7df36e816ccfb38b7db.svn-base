...
namespace NexGenFlow.NexGen
{
    ...
    public partial class doc_rin
    {
        static doc_rin()
        {
            DevExpress.Xpo.Metadata.XPClassInfo xpClass = (new Session()).GetClassInfo(typeof(doc_rin));
        ...
        public doc_rin(Session session) : base(session) { }
