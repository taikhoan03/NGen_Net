...
{
    public partial class doc_rin_input : UserControl
    {
        ...
        public DataObject.Record_RIN GetRecord()
        {
            ...
            try
            {
                ...
                //}
                _sr_no++;
                var rs = new DataObject.Record_RIN
                {
                    Image_2 = null,
                    Price = price,
                    Qty = qty,
        ...
        public void Load_record_to_editting_form(DataObject.Record_RIN doc_rin_input)
        {
