...
{
    public class Record_rsd
    {
        public static readonly log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public DataObject.QueryResult Insert(DataObject.Record_RSD record)
        {
            try
            {
                var new_record = new NexGenFlow.NexGen.doc_rsd(new Session());
                new_record.image_2 = record.Image_2;
                new_record.description = record.Item_description;
        ...
        public DataObject.QueryResult Insert(DataObject.Record_RSD record, Session session)
        {
            try
            {
                var new_record = new NexGenFlow.NexGen.doc_rsd(session);
                new_record.image_2 = record.Image_2;
                new_record.description = record.Item_description;
                new_record.per_item = record.Per_Item;
                new_record.price = record.Price;
        ...
        public DataObject.QueryResult Insert(List<DataObject.Record_RSD> records,long documentid,long keying_time,string username,string transaction_date, string transaction_time,double total_update)
        {
