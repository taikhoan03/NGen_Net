...
namespace NexGenFlow.NexGen
{
    ...
    public partial class doc_qc : XPLiteObject
    {
        long fid;
        [Key]
        public long id
        ...
        string frin_rsd_upc;
        [Size(255)]
        [Persistent(@"rin/rsd/upc")]
        public string rin_rsd_upc
        {
            get { return frin_rsd_upc; }
            set { SetPropertyValue<string>("rin_rsd_upc", ref frin_rsd_upc, value); }
        }
        double fprice;
        public double price
        {
        ...
        string frin_upc_rsd;
        [Size(255)]
        [Persistent(@"rin/upc_rsd")]
        public string rin_upc_rsd
        {
            get { return frin_upc_rsd; }
            set { SetPropertyValue<string>("rin_upc_rsd", ref frin_upc_rsd, value); }
        }
    }
